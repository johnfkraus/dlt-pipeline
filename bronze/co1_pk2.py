...
@dlt.resource(
    ...
    columns={
        # User columns from Excel - all TEXT
        ...
        # Custom generated UUID primary key
        "bronze_row_uuid": {
            "data_type": "uuid",
            "primary_key": True,
            "nullable": False,
            "default": "gen_random_uuid()",  # Postgres 13+ built-in [web:235]
            # Alternative for older Postgres: "uuid_generate_v4()"
        },
        # dlt system columns
...
def c01_bronze(
    ...
    # Read Excel spreadsheet [web:192][web:189]
    df = pd.read_excel(excel_path, dtype=str).fillna("")
    for rec in df.to_dict(orient="records"):
        # Don't include bronze_row_uuid in yield; it will be generated by Postgres
        yield C01Row(**rec)
