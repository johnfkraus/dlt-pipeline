# gold/gold_c01_polars.py
info = """
table co1 silver columns
------
contact: selector_a; to JSONB?
target: selector_b
person_a: name_a
person_b: name_b
date_of_first_interaction: date_of_interaction
date_of_last_interaction: to JSONB?
...
def main():
    ...
    with conn:
        ...
        df = df.with_columns(
            [
                pl.struct(["additional_info", "contact", "target", "date_of_first_interaction", "date_of_last_interaction",
                           "dataset_name"]).alias("other_info"),
